...
-- EMPLOYEES
INSERT INTO employee(id, name) values('1', 'Shiva Kumar');
INSERT INTO employee(id, name) values('2', 'Ananth Sharma');
INSERT INTO employee(id, name) values('3', 'Iqbal Hussain');
INSERT INTO employee(id, name) values('4', 'Kamil Kowaski');
INSERT INTO employee(id, name) values('5', 'Andrea Snetzer');

INSERT INTO employee(id, name, oe) values('11', 'Piyush Gaurav', 'ABCD');
INSERT INTO employee(id, name, oe) values('12', 'Anand Varma', 'EFGH');
INSERT INTO employee(id, name, oe) values('13', 'Bhuvan Tripathi', 'IJKL');
INSERT INTO employee(id, name, oe) values('14', 'David Roy', 'MNOP');
INSERT INTO employee(id, name, oe) values('15', 'Fatima Sana', 'QRST');

INSERT INTO employee(id, name, oe) values('111', 'Arman Maher', 'ABCD11');
INSERT INTO employee(id, name, oe) values('112', 'Babu Ramakrishna', 'ABCD21');
INSERT INTO employee(id, name, oe) values('113', 'Chetan Pingle', 'EFGH11');
INSERT INTO employee(id, name, oe) values('114', 'Deepa Venkateshwari', 'EFGH21');
INSERT INTO employee(id, name, oe) values('115', 'Devraj Ogle', 'IJKL11');
INSERT INTO employee(id, name, oe) values('116', 'Fana Raj', 'IJKL21');
INSERT INTO employee(id, name, oe) values('117', 'Fredrik Ardark', 'MNOP11');
INSERT INTO employee(id, name, oe) values('118', 'Gautam Rane', 'MNOP21');
INSERT INTO employee(id, name, oe) values('119', 'Ganesh Shagde', 'QRST11');
INSERT INTO employee(id, name, oe) values('120', 'Hema Tithate', 'QRST21');
INSERT INTO employee(id, name, oe) values('121', 'Induraj Dev', 'ABCD12');
INSERT INTO employee(id, name, oe) values('122', 'Karna Oza', 'ABCD22');
INSERT INTO employee(id, name, oe) values('123', 'Karishma Wagle', 'EFGH12');
INSERT INTO employee(id, name, oe) values('124', 'Laxmi N', 'EFGH22');
INSERT INTO employee(id, name, oe) values('125', 'Madhusudan Sahay', 'IJKL12');
INSERT INTO employee(id, name, oe) values('126', 'Mahesh Ranga', 'IJKL22');
INSERT INTO employee(id, name, oe) values('127', 'Nandiraj Dhingre', 'MNOP12');
INSERT INTO employee(id, name, oe) values('128', 'Naman Patoda', 'MNOP22');
INSERT INTO employee(id, name, oe) values('129', 'Parthasarthi', 'QRST12');
INSERT INTO employee(id, name, oe) values('130', 'Pandhare Puran', 'QRST22');
INSERT INTO employee(id, name, oe) values('131', 'Ravi Ranjan', 'ABCD13');
INSERT INTO employee(id, name, oe) values('132', 'Ramesh Jhindal', 'ABCD23');
INSERT INTO employee(id, name, oe) values('133', 'Shankar Seth', 'EFGH13');
INSERT INTO employee(id, name, oe) values('134', 'Vrajitha Tirthe', 'EFGH23');
INSERT INTO employee(id, name, oe) values('135', 'Vanita Fogat', 'IJKL13');
INSERT INTO employee(id, name, oe) values('136', 'Amar Yogindra', 'IJKL23');
INSERT INTO employee(id, name, oe) values('137', 'Timothy Jadken', 'MNOP13');
INSERT INTO employee(id, name, oe) values('138', 'Tanmay Padkar', 'MNOP23');
INSERT INTO employee(id, name, oe) values('139', 'Wasim Shaikh', 'QRST13');
INSERT INTO employee(id, name, oe) values('140', 'Wajir Rehman', 'QRST23');
INSERT INTO employee(id, name, oe) values('141', 'Athashree Santakar', 'ABCD14');
INSERT INTO employee(id, name, oe) values('142', 'Jamdev Patil', 'ABCD24');
INSERT INTO employee(id, name, oe) values('143', 'Harsha Chanda', 'EFGH14');
INSERT INTO employee(id, name, oe) values('144', 'Bhagirath Shah', 'EFGH24');
INSERT INTO employee(id, name, oe) values('145', 'Gargi Konkane', 'IJKL14');
INSERT INTO employee(id, name, oe) values('146', 'Umesh Yogale', 'IJKL24');
INSERT INTO employee(id, name, oe) values('147', 'Yogendra Raj', 'MNOP14');
INSERT INTO employee(id, name, oe) values('148', 'Ashwin Chowgule', 'MNOP24');
INSERT INTO employee(id, name, oe) values('149', 'Himesh Tapadiya', 'QRST14');
INSERT INTO employee(id, name, oe) values('150', 'Kaninga Lantaguram', 'QRST24');